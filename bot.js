...
const USER_AGENT = `NepalRP bot ${require('./package.json').version} , Node ${process.version} (${process.platform}${process.arch})`;
...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    let dot = TICK_N % 2 === 0 ? 'Nepal' : 'Roleplay';
    let embed = new Discord.RichEmbed()
    
    .setAuthor("WELCOME TO NEPAL ROLEPLAY ","https://cdn.discordapp.com/icons/665189160088371210/73564972a803b701985a512889682855.webp")
    .setTitle('LIVE SERVER STATUS')
    


    .setURL('https://discord.gg/djdA8DN')
    .setThumbnail('https://media.discordapp.net/attachments/706823835219132468/708149430913859634/FB_IMG_1588906309996.jpg')
    //.setImage('https://media.discordapp.net/attachments/706823835219132468/708149430913859634/FB_IMG_1588906309996.jpg')
    ...
    .addField(`Facebook Page`, `[Click Here To Visit Nepal Roleplay](https://www.facebook.com/Nepal.Roleplay)`)
  ...
  const offline = function() {
    ...
    //.addField('Waiting','?',true)
    .addField('ONLINE PLAYERSS','?\n\u200b\n',true);
    sendOrUpdate(embed);
    LAST_COUNT = null;
  ...
  const updateMessage = function() {
    getVars().then((vars) => {
      getPlayers().then((players) => {
        ...
        //.addField('Waiting',queue === 'Enabled' || queue === undefined ? '0' : queue.split(':')[1].trim(),true)
        .addField('ONLINE PLAYERS',`${players.length}/${MAX_PLAYERS}\n\u200b\n`,true)
        .addField('\u200b','\u200b\n',true)
        .addField('**To connect the server Press F8 and Enter:\nconnect fivem.nepalrp.com**','\u200b\n',true)
  ...
  bot.on('ready',() => {
   ...
   // bot.user.setGame('Nepal Roleplay', 'https://discord.gg/djdA8DN');
    bot.user.setActivity('Nepal RP',{'url':'https://discord.gg/djdA8DN','type':'Watching'});
    ...
    if (!message.author.bot) {
      if (message.member) {
        ...
        if (message.channel.id === BUG_CHANNEL) {
          ...
          .setColor(0x2894C2)
          .setTitle('Bug Report')
          .setDescription('Your message has been successfully sent to staff-team!')
          .setTimestamp(new Date());
